    ...
    <View style={Style.Container}>
      ...
      <View style={Style.StatusCon}>
        ...
        <View style={Style.BodyCon}>
              <Text style={Style.headingText}>Body Fast</Text>
              <Text style={Style.bodyTxt}> If your goal is to burn fat and lose weight, focus on strength-building exercises that target your whole body. Full-body exercises are ideal since they work several muscle groups at once, saving you time and energy..</Text>
